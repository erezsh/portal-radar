...
var app = (function () {
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "data-series", div_data_series_value = JSON.stringify(Object.entries(/*data*/ ctx[1])));
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*type*/ 1 && div_class_value !== (div_class_value = "graph " + /*type*/ ctx[0])) {
    				attr_dev(div, "class", div_class_value);
    			}

    			if (dirty & /*data*/ 2 && div_data_series_value !== (div_data_series_value = JSON.stringify(Object.entries(/*data*/ ctx[1])))) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (default_slot) {
    				...
    				if (default_slot_or_fallback && default_slot_or_fallback.p && dirty & /*type, data, data_elem*/ 7) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$set = $$props => {
    		...
    		if ("show_x_axis" in $$props) $$invalidate(5, show_x_axis = $$props.show_x_axis);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("height" in $$props) $$invalidate(4, height = $$props.height);
    		if ("show_x_axis" in $$props) $$invalidate(5, show_x_axis = $$props.show_x_axis);
    		if ("data_elem" in $$props) $$invalidate(2, data_elem = $$props.data_elem);
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t12 = space();
    			attr_dev(a, "href", a_href_value = "https://discord.com/channels/" + /*s*/ ctx[18].id + "/" + /*c*/ ctx[23].id);
    			...
    			attr_dev(time, "datetime", time_datetime_value = /*c*/ ctx[23].last_message.date);
    		...
    		p: function update(ctx, dirty) {
    			if ((!current || dirty & /*server_list*/ 1) && t0_value !== (t0_value = /*c*/ ctx[23].name + "")) set_data_dev(t0, t0_value);

    			if (!current || dirty & /*server_list*/ 1 && a_href_value !== (a_href_value = "https://discord.com/channels/" + /*s*/ ctx[18].id + "/" + /*c*/ ctx[23].id)) {
    				attr_dev(a, "href", a_href_value);
    			}

    			if ((!current || dirty & /*server_list*/ 1) && t2_value !== (t2_value = /*c*/ ctx[23].total_messages + "")) set_data_dev(t2, t2_value);
    			if ((!current || dirty & /*server_list*/ 1) && t5_value !== (t5_value = /*c*/ ctx[23].messages_last_hour + "")) set_data_dev(t5, t5_value);
    			if ((!current || dirty & /*server_list*/ 1) && t9_value !== (t9_value = /*c*/ ctx[23].last_message.date_text + "")) set_data_dev(t9, t9_value);

    			if (!current || dirty & /*server_list*/ 1 && time_datetime_value !== (time_datetime_value = /*c*/ ctx[23].last_message.date)) {
    				attr_dev(time, "datetime", time_datetime_value);
    			}

    			const graph0_changes = {};
    			if (dirty & /*server_list*/ 1) graph0_changes.data = /*c*/ ctx[23].mph_by_dow;
    			graph0.$set(graph0_changes);
    			const graph1_changes = {};
    			if (dirty & /*server_list*/ 1) graph1_changes.data = /*c*/ ctx[23].mph_by_hod;
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(139:31)       <p>...waiting for channels...</p>     {:then channel_list}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(time, "datetime", time_datetime_value = /*s*/ ctx[18].last_message.date);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*server_list*/ 1) && t0_value !== (t0_value = /*s*/ ctx[18].name + "")) set_data_dev(t0, t0_value);
    			if ((!current || dirty & /*server_list*/ 1) && t2_value !== (t2_value = /*s*/ ctx[18].total_members + "")) set_data_dev(t2, t2_value);
    			if ((!current || dirty & /*server_list*/ 1) && t5_value !== (t5_value = /*s*/ ctx[18].channel_count + "")) set_data_dev(t5, t5_value);
    			if ((!current || dirty & /*server_list*/ 1) && t8_value !== (t8_value = /*s*/ ctx[18].total_messages + "")) set_data_dev(t8, t8_value);
    			if ((!current || dirty & /*server_list*/ 1) && t14_value !== (t14_value = /*s*/ ctx[18].members_joined_last_24h + "")) set_data_dev(t14, t14_value);
    			if ((!current || dirty & /*server_list*/ 1) && t18_value !== (t18_value = /*s*/ ctx[18].members_joined_per_day_avg.toFixed(2) + "")) set_data_dev(t18, t18_value);
    			if ((!current || dirty & /*server_list*/ 1) && t24_value !== (t24_value = /*s*/ ctx[18].last_message.date_text + "")) set_data_dev(t24, t24_value);

    			if (!current || dirty & /*server_list*/ 1 && time_datetime_value !== (time_datetime_value = /*s*/ ctx[18].last_message.date)) {
    				attr_dev(time, "datetime", time_datetime_value);
    			}

    			if ((!current || dirty & /*server_list*/ 1) && t26_value !== (t26_value = /*s*/ ctx[18].messages_last_hour + "")) set_data_dev(t26, t26_value);
    			const graph0_changes = {};
    			if (dirty & /*server_list*/ 1) graph0_changes.data = /*s*/ ctx[18].mph_by_dow;
    			graph0.$set(graph0_changes);
    			const graph1_changes = {};
    			if (dirty & /*server_list*/ 1) graph1_changes.data = /*s*/ ctx[18].mph_by_hod;
    			graph1.$set(graph1_changes);
    			info.ctx = ctx;

    			if (dirty & /*server_list*/ 1 && promise !== (promise = /*get_channels*/ ctx[5](/*s*/ ctx[18].id)) && handle_promise(promise, info)) ; else {
    				const child_ctx = ctx.slice();
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*get_channels, server_list, sort_channels__total_messages, sort_channels__messages_last_hour, sort_channels__last_message, sort_channels__name*/ 63) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("server_list" in $$props) $$invalidate(0, server_list = $$props.server_list);
